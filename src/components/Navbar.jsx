    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>מפה ברחבי בית החולים.</h1>
          <ul className='hidden md:flex'>
          <li><Link to="home" smooth={true} duration={500}>קומה 3</Link></li>
          <li><Link to="about" smooth={true} offset={-200} duration={500}>קומה 4</Link></li>
          <li><Link to="support" smooth={true} offset={-50} duration={500}>קומה 5</Link></li>
          <li><Link to="platforms" smooth={true} offset={-100} duration={500}>נהל משתמשים</Link></li>
          <li><Link to="pricing" smooth={true} offset={-50} duration={500}>צ'אט</Link></li>
          </ul>
        </div>
        <div className='hidden md:flex pr-4'>
          <button className='border-none bg-transparent text-black ml-4'>
            התחבר
          </button>
          <button className='px-8 py-3'>הירשם</button>
        </div>
